...
<script type="text/python" src="/ag6_40323152/a2_40323152"></script>

<!-- 以協同方式加上 40323152 的 A 程式碼 -->
<script type="text/python" src="/ag6_40323152/a3_40323152"></script>

<!-- 以協同方式加上 40323152 的 A 程式碼 -->
<script type="text/python" src="/ag6_40323152/a4_40323152"></script>

<!-- 以協同方式加上 40323152 的 A 程式碼 -->
<script type="text/python" src="/ag6_40323152/a5_40323152"></script>
</body>
</html>
'''
    return outstring
    
@ag6_40323152.route('/a2_40323152')
def task2():
    outstring = '''
from javascript import JSConstructor
from browser import window
...
O(400, 0, 0, 0, 0, "lightgreen", True, 4)
'''
    return outstring
    
@ag6_40323152.route('/a3_40323152')
def task3():
    outstring = '''
from javascript import JSConstructor
from browser import window
...
O(800, 0, 0, 0, 0, "lightgreen", True, 4)
'''
    return outstring
    
@ag6_40323152.route('/a4_40323152')
def task4():
    outstring = '''
from javascript import JSConstructor
from browser import window
...
O(1200, 0, 0, 0, 0, "lightgreen", True, 4)
'''
    return outstring
    
@ag6_40323152.route('/a5_40323152')
def task5():
    outstring = '''
from javascript import JSConstructor
from browser import window
